...
public class ClientPanel extends JPanel implements MyPanel {
	...
	public void addClients(List<Client> clients) {
		...
		while (it.hasNext()) {
			...
			JLabel clientLbl = new JLabel(client.getNom());
			clientLbl.setName(client.getId() + "");
			listClients.add(clientLbl);
			clientLbl.addMouseListener(new MouseListener() {
				@Override
				public void mouseClicked(MouseEvent e) {
					JLabel wid = (JLabel) e.getSource();
					clientID = Long.parseLong(wid.getName());
					btnSave.setName("modifier");
					ClinetDBClicked(clientID);
