...
public class StockControlor {
	 ...
	 * 
	 * @param nom
	 *            c'est la designation du produit
	 * @param prixVente
	 *            c'est le prix de vente de produit mais rmq : il faut faire la
	 *            conversion de string vers double
	 * @param prixAchat
	 *            c'est le prix de achat de produit mais rmq : il faut faire la
	 *            conversion de string vers double
	 * @param cat
	 *            c'est le categorie de produit rechercher
	 * @return il return liste de produits trouver
	 * @throws Exception
	 *             il envoie exception c'est il y a des erreurs rmq : il faut
	 *             preciser le message en francais
	 */
	 ...
	 *            conversion de string vers double
	 * @param taxe
	 *            c'est le porcentage entre 0 et 100 rmq il faut envoyer un
	 *            exception si taxe n'est pas correcte
	 * @param qte
	 *            quantité de produit en stock valeur positive
	 * @param cat
	 ...
	 *            c'est le produit
	 * @throws Exception
	 *             Exception il envoie exception c'est il y a des erreurs rmq :
	 *             il faut preciser le message en francais
	 */
